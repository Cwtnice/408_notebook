...
7. 在 *N* 个顶点的无向图中，所有顶点的度之和不会超过顶点数的多少倍？==N−1==
...
2. 如果无向图 G 必须进行两次广度优先搜索才能访问其所有顶点，则下列说法中不正确的是：==A==
...
7. 【878，2017】以下哪个命题是正确的？ **D**
    ...
    ```c++
    A. 对于带权无向图 G = (V, E)，M 是 G 的最小生成树，则 M 中任意两点 V1 到 V2 的路径一定是它们之间的最短路径	
...
1. 【878，2018】若二叉搜索树（排序树）是有 *N* 个结点的完全二叉树，则不正确的说法是 ==B==
...
2. 【2012】AVL的高度为6，所有非叶结点的平衡因子均为1，则总结点数为：==20==
